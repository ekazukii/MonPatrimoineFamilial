...
const UserValidation = ({dataUsers}) => {
        ...
        },
        {
            ...
            cell: (row) => (
                <>
                    ...
                    ></i>
                    <i
                        className="fi fi-ss-delete-user m-r-3"
...
const ExampleDataSet = ({dataUsers}) => {
    // Liste des clés que vous souhaitez extraire
    const keysToExtract = ["id","username", "firstname", "lastname", "email", "validated"];
    // État pour stocker les données extraites
    const [bodies, setBodies] = useState([]);
    ...
    const headers= [
        ...
        },
        {
            ...
            prop: 'validated',
            title: 'Compte validé',
            cell: (row) => (row.validated ? 'Oui' : 'Non')
        },
        {
            prop: "button",
            title: "Actions",
            ...
            cell: (row) => (
                <>
                        <i className="fi fi-ss-user-gear me-2"
                           onClick={() => {
                               alert(`copier ${row.id}`);
...
const AdminPage = () => {
    ...
    return (
        <>
            <Container>
                <Row>
                    <UserValidation dataUsers={dataAllUsers}/>
                </Row>
            </Container>
        </>
    );
